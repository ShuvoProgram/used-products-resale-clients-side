                ...
                advertise.map(ad => (
                  ...
                  <SwiperSlide className='max-w-sm'>
                        <div class="w-full max-w-sm overflow-hidden bg-white rounded-lg shadow-lg dark:bg-gray-800">
                            <img class="object-cover object-center w-full h-56" src={ad.img} alt={ad.title}/>
                                ...
                                <div class="px-6 py-4">
                                    <h1 class="text-xl font-semibold text-gray-800 dark:text-white">{ad.title}</h1>
                                    ...
                                    <div class="flex items-center mt-4 text-gray-700 dark:text-gray-200">
                                        ...
                                        <h1 class="px-2 text-sm">Reseller Price: {ad.resellerPrice}</h1>
                                    </div>
                                    ...
                                    <div class="flex items-center mt-4 text-gray-700 dark:text-gray-200">
                                        ...
                                        <h1 class="px-2 text-sm">Condition: {ad.condition}</h1>
                                    </div>
